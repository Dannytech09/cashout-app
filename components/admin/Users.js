...
export default function Users({ users }) {
  return (
         <div className="border text-xs h-full border-solid bg-slate-500 border-slate-500 p-2 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 ml-4 mr-4 justify-center mt-40 mb-40">
        {users.map((user) => (
          <div
            key={user._id}
            className="border shadow-md p-3 flex flex-col justify-center flex-wrap"
          >
            <div className="flex hover:pointer hover:text-cyan-500 ">
