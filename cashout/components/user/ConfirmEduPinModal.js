...
const ConfirmEduPinModal = ({ name, vol, modalIsOpen, onRequestClose, onConfirm, children }) => {
  return (
    ...
    <div className='p-6'>
      <h2 className='text-1xl'>You are about to purchase {vol} pin of {name} token</h2>
...
export default ConfirmEduPinModal;
