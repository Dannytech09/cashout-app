    ...
    <>
      ...
      <form onSubmit={submit} className="mt-[-5ch]">
        <div className="p-10">
          <div className="text-center">
            ...
            <div className="">
              <div className="text-center">
                <h4 className="text-lg font-semibold">Data Balance Checker:</h4>
              </div>
      ...
      <div className="flex flex-col justify-center mt-[-2ch]">
        ...
        <div className="mx-auto text-lg">
          <h1 className="font-bold font-serif border-2-green bg-green-300 mx-auto text-center  ">
            Beneficiary List
          </h1>
          <Beneficiary
            beneficiary={beneficiary}
            onPhoneClickClear={clearPhoneClick}
