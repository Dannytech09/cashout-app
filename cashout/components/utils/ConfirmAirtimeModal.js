...
const ConfirmAirtimeModal = ({ network, amount, phoneNumber, modalIsOpen, onRequestClose, onConfirm, children }) => {
  return (
    ...
    <div className='p-6'>
      <h2 className='text-1xl'>You are about to purchase {network} {amount} airtime to {phoneNumber}</h2>
