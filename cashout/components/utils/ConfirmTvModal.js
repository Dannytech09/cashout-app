...
const ConfirmTvModal = ({ selectedVariation, iucNumber, modalIsOpen, onRequestClose, onConfirm, children }) => {
  return (
    ...
    <div className='p-6'>
      <h2 className='text-1xl'>You are about to purchase {selectedVariation} to {iucNumber}</h2>
