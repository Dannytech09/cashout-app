...
export default function Contact() {
  return (
    <section>
      <div className="max-w-6xl mx-auto mb-[-5ch] bg-white dark:bg-gray-800 antialiased">
        <h1 className=" text-3xl md:text-5xl font-bold py-20 text-center md:text-left">
          Contact Us
        </h1>
      </div>
          ...
          <div className="md:ml-4">
            <header className="">
              ...
              <p className="font-light text-base text-gray-200 mt-2">
                Caption your thought with few words in the box below.
              </p>
            </header>
