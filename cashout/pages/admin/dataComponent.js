   ...
   return (
    ...
    <div className="flex flex-col gap-4 p-4 text-center">
      ...
      <div className="border rounded-md bg-yellow-100 p-4">
        <Link href={"/admin/getAllPurchases"} className="text-gray-600 hover:text-gray-800 font-medium">
        Cable and Elect History
        </Link>
      </div>
      <div className="border rounded-md bg-blue-100 p-4">
        <Link href={"/admin/getDataPrices"} className="text-gray-600 hover:text-gray-800 font-medium">
          Get Current Prices - A
        </Link>
      </div>
      <div className="border rounded-md bg-yellow-100 p-4">
        <Link href={"/admin/setPrices"} className="text-gray-600 hover:text-gray-800 font-medium">
          Update Prices - A
        </Link>
      </div>
