      ...
      <div className="p-3">
        ...
        {user && (
          <div className="flex justify-around">
            <p className="text-center">Dear {user.username}, these are your basic info. Please keep it safe..</p>
          </div>
        )}
        ...
        <Link className="hover:text-slate-800" href={"/admin/dashboard"}>Goto Admin Dashboard</Link>
       </div>
      </div>
      </Layout>
    </div>
